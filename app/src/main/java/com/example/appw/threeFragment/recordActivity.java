...
//        swipeRefreshLayout.setRefreshing(true);
    ...
    public  void RecordRequest(final String UserID) {
        //请求地址
        String url = "http://129.28.162.46:8000/mine/search/";
//        String url = "http://192.168.12.52:8084/MyFirstWebApp/record";
        // " http://127.0.0.1:8080/MyFirstWebApp/LoginServlet";    //注①
        String tag = "SearchRecord";    //注②
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i=0;i<jsonArray.length();i++)
                            {
                                ...
                                decs.add(json.getString("firmName")+"/"+json.getString("time"));
                            }
