package com.example.appw.flashActivity;
...
//    private ImageView picIV;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nums=0;
        numc=0;
        displaySfv = this.findViewById(R.id.sf_display_demo_camera2);
...
//                {
//                    opens=true;
//                    start_times=System.currentTimeMillis();
//                }
//
//                float lux = event.values[0];
//                if (System.currentTimeMillis()-start_times<=10000)
//                {
//                    nums++;
//                }
//                Log.e(TAG, "光线传感器得到的光线强度-->" + lux+" num:"+nums);
//            }
//        }
        ...
        camera.setPreviewCallback(new Camera.PreviewCallback() {
            ...
            public void onPreviewFrame(byte[] data, Camera camera) {
                ...
                if (Math.abs(data.length - pixeCount * 1.5f) < 0.00001f) {
                    ...
                    Log.e(TAG, "摄像头环境亮度为 ： " + cameraLight+" numc:"+numc);
                    if (!isFinishing()) {
                        //亮度过暗就提醒
